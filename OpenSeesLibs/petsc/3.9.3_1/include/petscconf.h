...
#ifndef PETSC_DIR
#define PETSC_DIR "/usr/local/Cellar/petsc/3.9.3_1"
#endif

#ifndef PETSC_LIB_DIR
#define PETSC_LIB_DIR "/usr/local/Cellar/petsc/3.9.3_1/lib"
#endif
...
#define PETSC_MPICC_SHOW "clang -I/usr/local/Cellar/open-mpi/4.0.0/include -L/usr/local/opt/libevent/lib -L/usr/local/Cellar/open-mpi/4.0.0/lib -lmpi"
#endif
...
#define PETSC_FORTRAN_TYPE_INITIALIZE  = 0
#endif
...
#ifndef PETSC_HAVE_LIBSYSTEM
#define PETSC_HAVE_LIBSYSTEM 1
#endif
